 ...
 * `<BaseNode />` component.
 */
function BaseNodeHeader({ className, ...props }: ComponentProps<"header">) {
  return (
    <header
      {...props}
      className={cn(
 ...
 */
function BaseNodeHeaderTitle({ className, ...props }: ComponentProps<"h3">) {
  return (
    <h3
...
function BaseNodeContent({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
...
function BaseNodeFooter({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
